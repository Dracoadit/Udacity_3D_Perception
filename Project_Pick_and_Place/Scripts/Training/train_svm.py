...
training_set = pickle.load(open('training_set_project_list3_250.sav', 'rb'))
...
scores = cross_val_score(cv=kf, estimator=clf,
                                         X=X_train,
                                         y=y_train,
                                         scoring='accuracy'
                                        )
...
pickle.dump(model, open('model_project_list3_250.sav', 'wb'))
